  ...
  <div class="row">
    ...
    <div class="col-lg-8">
      ...
      <button
        ...
        class="btn btn-primary btn-border mr-2"
        v-else
        v-on:click="addFavorite(restaurant.id)"
      >
        加到最愛
      </button>
      <button
        ...
        v-on:click="deleteLike(restaurant.id)"
      >
        Unlike
      </button>
      <button
        ...
        v-else
        v-on:click="addLike(restaurant.id)"
      >
        Like
      </button>
    </div>
...
export default {
  ...
  watch: {
    initialrestaurant: {
      handler() {
        this.restaurant = { ...this.restaurant, ...this.initialrestaurant };
      },
    },
  },
};
